...
int main (void) 
{
   ...
   XGpio dip, push, leds;
   int psb_check, dip_check, dip_check_prev, count, Status, Value = 5;
   ...
   XScuTimer_LoadTimer(TimerInstancePtr, Value);  //ONE_TENTH*5); ONE_TENTH*dip_check_prev); hertz to seconds convertion -> 5hz=5cps=0.2sec
